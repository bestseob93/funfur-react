                    ...
                    <div className="container">
                        <div className="row m-b-lg">
                            <div className="col-lg-12 text-center" >
                                <ul className="style">
                                    <li><a target="_blank" href="http://intro.funfur.kr/">회사소개</a></li>
                                    <li><a href="#">이용약관</a></li>
                        ...
                        <div className="row m-b-lg">
                            <div className="col-lg-4 col-lg-offset-3">
                                <p>
                                    ...
                                    <strong><span className="navy">뻔뻐, Inc.</span></strong><br/> 대표: 유덕열 외 3명<br/> 주소: 서울시 송파구 방이동 62-8 석정빌딩 502호 <br/> 전화: 010-9251-6202 팩스: 0504-433-6202 <br/> 제휴문의: unit9251@naver.com
                                </p>
                            </div>
